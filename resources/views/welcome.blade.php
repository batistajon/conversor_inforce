...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="d-flex text-center h-100 text-white bg-dark flex-column">
        <div class="cover-container d-flex w-50 h-100 p-3 mx-auto flex-column">
            <header id="header" class="logo">
                ...
                <p class="mt-4">Jonathas Batista</p>
            </header>
            <main class="px-3 conteudo flex-column justify-content-center">
